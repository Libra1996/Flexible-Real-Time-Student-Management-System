...
<script type="text/javascript">
	$(function(){
		//Click the picture to generate Captcha
		...
		$("#submitBtn").click(function(){
			...
			$.ajax({
				...
				success: function(msg){
					if("vcodeError" == msg){
						$.messager.alert("System alert","Invalid captcha code!!!", "warning");
						$("#vcodeImg").click();//Update captcha
						$("input[name='vcode']").val("");//Clear the captcha box
					} else if("loginError" == msg){
						$.messager.alert("System alert", "Wrong user name or password!", "warning");
						$("#vcodeImg").click();//Update captcha
						$("input[name='vcode']").val("");//Clear the captcha box
...
<meta name="keywords" content="SpartanWeb">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">SpartanWeb</h2>
</div>
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="Click picture to generate a captcha" id="vcodeImg" src="CpachaServlet?method=loginCapcha"></div>
      </div>
...
<div class="footer">Copyright &nbsp; SpartanWeb @ Team 3 </div>
