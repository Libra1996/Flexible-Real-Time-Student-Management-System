	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'sn',title:'Student number',width:180, sortable: true},    
 		        {field:'name',title:'Name',width:200},
 		        {field:'sex',title:'Sex',width:100},
 		        {field:'mobile',title:'Phone number',width:150},
	    ...
	    $("#edit").click(function(){
        	...
        	if(selectRows.length != 1){
            	$.messager.alert("Alert message", "Please pick one item to modify!", "warning");
            } else{
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	$.messager.alert("System alert", "Please pick one item to modify!", "warning");
            } else{
            	var numbers = [];
            	...
            	$.messager.confirm("System alert", "All data related to the student (including grades) will be deleted, confirm to continue?", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							...
							success: function(msg){
								if(msg == "success"){
									$.messager.alert("System alert","Deleted sucessfully!","info");
									//Reload datagrid
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										$.messager.alert("System alert","Add sucessfully!","info");
										//Close the window
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										$.messager.alert("System alert","Update successfully!","info");
										//Close the window
										...
										$.messager.alert("System alert","Update failed!","warning");
										return;
									}
								}
							});
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>Name:</td>
	    			<td><input id="add_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="name" data-options="required:true, missingMessage:'Please enter a name'" /></td>
	    		</tr>
	    		<tr>
	    			<td>Password:</td>
	    			<td>
	    		...
	    		<tr>
	    			<td>Sex:</td>
	    			<td><select id="add_sex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 70, height: 30" name="sex"><option value="male">male</option><option value="female">female</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>Phone:</td>
	    		...
	    		<tr>
	    			<td>Email:</td>
	    			<td><input id="add_email" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="email" validType="email" /></td>
	    		</tr>
	    		<tr>
	    			<td>Major:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>Name:</td>
	    			<td><input id="edit_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="name" data-options="required:true, missingMessage:'Please enter a name'" /></td>
	    		</tr>
	    		<tr>
	    			<td>Sex:</td>
...
<!-- Submit form handle iframe framework -->
