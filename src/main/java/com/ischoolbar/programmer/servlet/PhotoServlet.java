...
public class PhotoServlet extends HttpServlet {
	...
	private void uploadPhoto(HttpServletRequest request,
		...
		try {
			...
			System.out.println(uploadInputStream);
			if(sid != 0){
			...
			try {
				response.getWriter().write("<div id='message'>protocol connection failed</div>");
			...
			try {
				response.getWriter().write("<div id='message'>Empty file!</div>");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			// TODO: handle exception
			try {
				response.getWriter().write("<div id='message'>Size invalid"+fileUpload.getFileSize()+"Please redo!</div>");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			// TODO: handle exception
			try {
				response.getWriter().write("<div id='message'>we got an ioexception</div>");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			// TODO: handle exception
			try {
				response.getWriter().write("<div id='message'>file format invalid"+fileUpload.getFileFormat()+"Please redo!</div>");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			// TODO: handle exception
			try {
				response.getWriter().write("<div id='message'>Photo can't be uploaded</div>");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
